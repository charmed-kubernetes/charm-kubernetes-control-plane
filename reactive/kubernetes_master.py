...
@when('etcd.available')
def reconfigure_apiserver(etcd, force_privilege=False):
    configure_apiserver(
        etcd.get_connection_string(), force_privilege)
...
def configure_apiserver(etcd_connection_string, force_privilege=False):
    api_opts = {}
    ...
    if is_privileged() or force_privilege:
