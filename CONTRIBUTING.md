...
1. [Submit a bug](https://bugs.launchpad.net/charm-kubernetes-control-plane/+filebug) to explain the need for and track the change.
...
See [this page](https://github.com/charmed-kubernetes/kubernetes-docs/blob/main/pages/k8s/charm-kubernetes-master.md)
